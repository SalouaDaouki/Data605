...
filtered_Train_df <- Train_df_subset[Train_df_subset$LotArea > x_threshold & Train_df_subset$SalePrice > y_threshold, ]
...
filtered_data_Y_exceeds <- Train_df_subset[Train_df_subset$SalePrice > y_threshold, ]
...
filtered_Train_df_both_leq <- Train_df_subset[Train_df_subset$LotArea <= x_threshold & Train_df_subset$SalePrice <= y_threshold, ]
...
filtered_Train_df_X_leq_Y_g <- Train_df_subset[Train_df_subset$LotArea <= x_threshold & Train_df_subset$SalePrice > y_threshold, ]
...
for (col in names(Train_df_subset)[numerical_vars]) {
  print(ggplot(Train_df_subset, aes_string(x = col)) +
...
plot(Train_df_subset$LotArea, Train_df_subset$SalePrice, 
...
```{r}
# Log transformation
plot(log(Train_df_subset$LotArea), log(Train_df_subset$SalePrice), 
...
t_test_result <- t.test(Train_df_subset$LotArea, Train_df_subset$SalePrice)
...
subset_df <- Train_df_subset[, c("LotArea", "SalePrice")]
