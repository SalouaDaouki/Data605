...
# Create a data frame with Id and predicted SalePrice
predictions <- data.frame(Id = numerical_data$Id, SalePrice = round(predicted_SalePrice, 0))
...
```{r}
write.csv(Train_df_subset, file = "/Users/salouadaouki/Desktop/Data605/Submission.csv", row.names = FALSE)
```
